...
plt.xticks(x,fontproperties = 'Times New Roman', size = 20)
plt.yticks(y,fontproperties = 'Times New Roman', size = 20)
...
plt.text(-50,60,'ACVP VS non-ACVP'+ "=" + str(round(acvp_nonavp_best_res[0],3)),fontdict={'family': 'Times New Roman', 'size': 16})
plt.text(-50,50,'RelACVP VS nonACVP'+ "=" + str(round(leakacvp_nonavp_best_res[0],3)),fontdict={'family': 'Times New Roman', 'size': 16})
plt.text(-50,40,'ACVP VS RelACVP'+ "=" + str(round(leak_acvp_best_res[0],3)),fontdict={'family': 'Times New Roman', 'size': 16})
